    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {showDropdown && (
        <div className="absolute right-0 mt-3 w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 max-h-96 overflow-hidden flex flex-col animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-purple-600 text-white p-5 flex justify-between items-center">
                      ...
                      <div className="flex gap-1.5 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                        {!notification.isRead && (
                          <button
                            ...
                            className="p-1.5 text-xs bg-white hover:bg-green-100 text-green-600 rounded-lg hover:scale-110 transition-all shadow-sm"
                            title="Mark as read"
                          >
                            ✓
                          </button>
                        ...
                        <button
                          ...
                          className="p-1.5 text-xs bg-white hover:bg-red-100 text-red-600 rounded-lg hover:scale-110 transition-all shadow-sm"
                          title="Delete"
                        >
                          ✕
                        </button>

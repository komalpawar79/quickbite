        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <button
              ...
              className="w-full mt-3 bg-gray-200 text-gray-900 py-2 rounded-lg font-semibold hover:bg-gray-300 transition"
            >
              Skip for Now
            </button>
          </motion.div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Select Delivery Mode</h2>
              ...
              {orderMode === 'delivery' && (
                <div className="bg-white p-6 rounded-lg shadow">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">📍 Delivery Location</h2>
                  <p className="text-gray-600 text-sm mb-3">Where should we deliver your order?</p>
                  <textarea
                    value={address}
                    onChange={(e) => setAddress(e.target.value)}
                    placeholder="E.g. Campus - Building A, Block 2..."
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <motion.button
                  ...
                  className="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white py-3 font-bold rounded-lg flex items-center justify-center gap-2 disabled:opacity-50"
        ...
        {showSummary && (
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Confirm Order?</h3>
              <p className="text-gray-600 mb-6">
                Order Mode: <span className="font-bold capitalize text-gray-900">{orderMode}</span>
                <br />
                Payment: <span className="font-bold capitalize text-gray-900">{paymentMethod}</span>
                <br />
                {address && (
                  <>
                    Location: <span className="font-bold text-gray-900">{address}</span>
                    <br />
                  </>
                )}
                Total: <span className="font-bold text-blue-600">₹{finalTotal}</span>
              </p>
              <div className="flex gap-4">
                <button
                  onClick={() => setShowSummary(false)}
                  disabled={loading}
                  className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-gray-900 hover:bg-gray-100 transition disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
